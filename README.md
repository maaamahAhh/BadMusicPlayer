...
Plays MP3, WAV, OGG, FLAC, XM, MOD, QOA. Extracts cover art and accent colors from file metadata. All visualizations run at once without intensity limits — expect flashing (Photosensitive Epilepsy Warning).
